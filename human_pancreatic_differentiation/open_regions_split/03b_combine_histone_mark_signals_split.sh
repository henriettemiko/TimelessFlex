...
##########
#name:          03b_combine_histone_mark_signals_split.sh
...
Rscript $SCRIPT_DIR/open_regions_split/get_normalized_FC_split.r \
    all_max_counts_prom.txt "_prom" "promoters"

#the files allCountsNorm and allFold are ordered in D0, D2, D5, D7, D10, D8 and 
#D2/D0, D5/D2, D7/D5, D10/D7, D8/D5
