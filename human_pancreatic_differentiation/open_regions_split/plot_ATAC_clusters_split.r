...
##########
#name:          plot_ATAC_clusters_split.r
#description:   plots ATAC signal for clusters for split
...
for (i in 1:numClusters) {
    ...
    prom.peaks.numbers[prom.peaks.numbers$V2=="D8",]$V1/normD8)
...
for (i in 1:numClusters) {
    ...
    merged.peaks.prom = read.table(paste0(numcluster.dir,
                                          ...
                                          "_all.txt"), header=F)
    colnames(merged.peaks.prom)=c("D0", "D2", "D5", "D7", "D10", "D8")
    ...
    boxplot(merged.peaks.prom, names = c("D0", "D2", "D5", "D7", "D10", "D8"),  
