...
##########
#name:          04e_plot_clusters_fullset_kmeans.sh
#description:   calls plotting of k-means initialization for fullset
...
Rscript $SCRIPT_DIR/open_regions_fullset/plot_clusters_fullset_kmeans.r \
