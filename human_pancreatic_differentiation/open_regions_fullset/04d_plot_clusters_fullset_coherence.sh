...
##########
#name:          04d_plot_clusters_fullset_coherence.sh
#description:   calls plotting of coherence plot for fullset
...
Rscript $SCRIPT_DIR/open_regions_fullset/plot_clusters_coherence.r \
    $NUM_CLUSTER_PROM $NUM_MARKS $NUM_TIME_POINTS $MODEL_DIR_PROM \
    $TIMELESS_DIR_PROM $SIGNAL_GENERATOR_DIR_PROM "promoter" 

Rscript $SCRIPT_DIR/open_regions_fullset/plot_clusters_coherence_fold.r \
    $NUM_CLUSTER_PROM $NUM_MARKS $NUM_TIME_POINTS $MODEL_DIR_PROM \
    $TIMELESS_DIR_PROM $SIGNAL_GENERATOR_DIR_PROM "promoter" 

Rscript $SCRIPT_DIR/open_regions_fullset/plot_clusters_coherence_both.r \
    $NUM_CLUSTER_PROM $NUM_MARKS $NUM_TIME_POINTS $MODEL_DIR_PROM \
    $TIMELESS_DIR_PROM $SIGNAL_GENERATOR_DIR_PROM "promoter" 
