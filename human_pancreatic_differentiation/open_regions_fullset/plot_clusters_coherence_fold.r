...
#description:   plots cluster coherence for fold changes fullset
...
# 4 fold changes
k27ac = cbind(k[[1]], k[[2]], k[[3]], k[[4]])
k27me3 = cbind(k[[5]], k[[6]], k[[7]], k[[8]])
k4me1 = cbind(k[[9]], k[[10]], k[[11]], k[[12]])
k4me3 = cbind(k[[13]], k[[14]], k[[15]], k[[16]])
