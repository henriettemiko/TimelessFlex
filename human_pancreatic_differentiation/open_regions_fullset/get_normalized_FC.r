...
m1 = normalizeQuantiles(cbind(l[[12]], l[[13]], l[[14]],l[[15]], l[[16]])) 
m2 = normalizeQuantiles(cbind(l[[17]], l[[18]], l[[19]],l[[20]], l[[21]])) 
m3 = normalizeQuantiles(cbind(l[[22]], l[[23]], l[[24]],l[[25]], l[[26]])) 
m4 = normalizeQuantiles(cbind(l[[27]], l[[28]], l[[29]],l[[30]], l[[31]])) 
...
#it is ordered for D0, D10, D2, D5, D7
#now reorder for each histone modification to D0, D2, D5, D7, D10
#regions 1-11
#histone modification 1: col 12-16 etc
n.reordered = cbind(l[g,seq(1:11)],filtered1[,c(1,3,4,5,2)],
