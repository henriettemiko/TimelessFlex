...
##########
#name:          04b_select_model_pairs_multi.sh
#description:   calls plotting of model selection criteria for pairs multi
...
cd $TIMELESS_DIR_MULTI_PROM_ENH
...
Rscript $SCRIPT_DIR/open_regions_subset/open_regions_pairs/plot_AIC_BIC.r \
    AIC.txt BIC.txt $TIMELESS_DIR_MULTI_PROM_ENH likelihood.txt numPar.txt


cd $TIMELESS_DIR_MULTI_PROM_PROM
...
Rscript $SCRIPT_DIR/open_regions_subset/open_regions_pairs/plot_AIC_BIC.r \
    AIC.txt BIC.txt $TIMELESS_DIR_MULTI_PROM_PROM likelihood.txt numPar.txt


cd $TIMELESS_DIR_MULTI_ENH_ENH
...
Rscript $SCRIPT_DIR/open_regions_subset/open_regions_pairs/plot_AIC_BIC.r \
    AIC.txt BIC.txt $TIMELESS_DIR_MULTI_ENH_ENH likelihood.txt numPar.txt
