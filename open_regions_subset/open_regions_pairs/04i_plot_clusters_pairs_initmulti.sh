...
cat $SIGNAL_GENERATOR_DIR_INIT_PROM_ENH/allCountsNorm.txt $SIGNAL_GENERATOR_DIR_INIT_PROM_PROM/allCountsNorm.txt $SIGNAL_GENERATOR_DIR_INIT_ENH_ENH/allCountsNorm.txt $SIGNAL_GENERATOR_DIR_MULTI_PROM_ENH/allCountsNorm.txt $SIGNAL_GENERATOR_DIR_MULTI_PROM_PROM/allCountsNorm.txt $SIGNAL_GENERATOR_DIR_MULTI_ENH_ENH/allCountsNorm.txt > allCountsNorm.txt
