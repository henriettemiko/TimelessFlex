...
##########
#name:          05b_signature_genes_promoter_init.sh
#description:   plots number of signature genes and promoter clusters pairs init
...
plot_cluster_signature_genes_pairs.r \
    ...
    $SIGNAL_GENERATOR_DIR_INIT_PROM_ENH \
...
plot_cluster_signature_genes_pairs_prom-prom.r \
    ...
    $SIGNAL_GENERATOR_DIR_INIT_PROM_PROM \
    $NUM_CLUSTER_DIR_INIT_PROM_PROM "init_prom-prom"
