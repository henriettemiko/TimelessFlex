...
SIGNAL_GENERATOR_DIR_MULTI_ENH_ENH=${OPEN_REGIONS_DIR_PAIRS}_noordering/\
Signal_Generator_multi_enh-enh
TIMELESS_DIR_MULTI_ENH_ENH=${OPEN_REGIONS_DIR_PAIRS}_noordering/timeless_multi_enh-enh
