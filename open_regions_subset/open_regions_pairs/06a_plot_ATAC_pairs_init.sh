...
SIGNAL_GENERATOR_DIR_INIT_PROM_ENH=${OPEN_REGIONS_DIR_PAIRS}_noordering/\
Signal_Generator_init_prom-enh
TIMELESS_DIR_INIT_PROM_ENH=${OPEN_REGIONS_DIR_PAIRS}_noordering/timeless_init_prom-enh
...
SIGNAL_GENERATOR_DIR_INIT_PROM_PROM=${OPEN_REGIONS_DIR_PAIRS}_noordering/\
Signal_Generator_init_prom-prom
TIMELESS_DIR_INIT_PROM_PROM=${OPEN_REGIONS_DIR_PAIRS}_noordering/timeless_init_prom-prom
...
SIGNAL_GENERATOR_DIR_INIT_ENH_ENH=${OPEN_REGIONS_DIR_PAIRS}_noordering/\
Signal_Generator_init_enh-enh
TIMELESS_DIR_INIT_ENH_ENH=${OPEN_REGIONS_DIR_PAIRS}_noordering/timeless_init_enh-enh
