...
%define paths
cd '/fast/AG_Ohler/henriette/hematopoiesis/bnt-master';
...
for (numClusters = startNum:endNum)
    ...
    % 5 fold changes and 4 histone marks
    ...
    % second histone modification tree H3K4me1
    dag(7,8) = 1;
    dag(9,10) = 1;
    dag(9,11) = 1;
    
    % third histone modification tree H3K4me2
    dag(12,13) = 1;
    dag(14,15) = 1;
    dag(14,16) = 1;

    % fourth histone modification tree H3K4me3
    dag(17,18) = 1;
    dag(19,20) = 1;
    dag(19,21) = 1;
