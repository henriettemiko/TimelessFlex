...
##########
#name:          02a_compute_feature_regions_split.sh
#description:   compute feature region windows around open regions split
...
FEATURE_REGIONS_DIR=$OPEN_REGIONS_DIR_SPLIT/get_feature_regions
...
do
    ...
    Rscript $SCRIPT_DIR/open_regions_fullset/plot_feature_region_widths.r \
