...
#description:   plot gene expression (FPKM from RSEM) for promoter clusters
...
for (i in 1:numClusters) {
    ...
    cur.scores <- geomav.fpkm.reordered[cur.items,2:6]
...
for (i in 1:numClusters) {
    ...
    cur.scores <- mean.fpkm.reordered[cur.items,2:6]
