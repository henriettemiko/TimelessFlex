...
paste regions_${NUM_CLUSTER_ENH}_CMP_cutsites.bed \
    <( cut -f 11 regions_${NUM_CLUSTER_ENH}_MEP_cutsites.bed ) \
    <( cut -f 11  regions_${NUM_CLUSTER_ENH}_EryA_cutsites.bed ) \
    <( cut -f 11  regions_${NUM_CLUSTER_ENH}_GMP_cutsites.bed ) \
    <( cut -f 11  regions_${NUM_CLUSTER_ENH}_Granu_cutsites.bed ) \
    <( cut -f 11  regions_${NUM_CLUSTER_ENH}_Mono_cutsites.bed ) | \
